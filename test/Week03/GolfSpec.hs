...
skipsSpec :: Spec
skipsSpec = describe "skips" $ it "returns the correct list" $ do
...
localMaximaSpec = describe "localMaxima" $ it "finds all local maxima" $ do
...
histogramSpec :: Spec
histogramSpec =
  describe "histogram" $ it "returns the correct histogram representation" $ do
